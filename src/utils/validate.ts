 ...
 */
export const checkForLinkedCandies = (chain: number, board: object[]): void => {
 ...
 */
const checkForColumn = (board: object[], index: number, chain: number, maxBoardSize: number): void => {
 ...
 * @param chain Length of candies consecutively in a row/col
 */
const checkForRow = (board: object[], index: number, chain: number): void => {
    const invalidIndices = []
    var power = 1
 ...
 */
const validate = (board: object[], index: number, rowColumn: number[]): void => {
